...
A flexible Flutter widget for selecting ranges of items with draggable handles. Features a dynamic grid layout, two display modes (transparent overlay or lens effect), and full customization options. [Link to pub.dev](https://pub.dev/packages/draggable_range_selector)
...
![](https://github.com/AIPEAC/draggable-range-selector/blob/main/assets/1.gif)
